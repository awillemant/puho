...
public class ByYearStrategyTests {
    ...
    public void shouldReturnInternalImplementation() throws Exception {
        ...
        //WHEN
        List<LocalDate> puhos = strategy.getPublicHolidaysByYear(1983);
        //THEN
        assertThat(puhos).containsExactly(LocalDate.of(1983,1,1),LocalDate.of(1983,6,12),LocalDate.of(1983,12,25));
    }
